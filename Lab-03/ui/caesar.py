...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label.setGeometry(QtCore.QRect(336, 20, 101, 20))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.txt_cipher_text.setGeometry(QtCore.QRect(120, 280, 601, 71))
        self.txt_cipher_text.setObjectName("txt_cipher_text")
        self.txt_key = QtWidgets.QLineEdit(self.centralwidget)
        self.txt_key.setGeometry(QtCore.QRect(120, 170, 601, 20))
        self.txt_key.setObjectName("txt_key")
        self.txt_plain_text = QtWidgets.QTextEdit(self.centralwidget)
        self.txt_plain_text.setGeometry(QtCore.QRect(120, 70, 601, 71))
